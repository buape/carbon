...
You can setup a generic Embed that you can use in multiple places by extending the [`Embed`](/api/carbon/embed) class, and adding properties there or in the constructor.
...
Here we have created an embed with a title, description, and URL. You can use this embed in a message by using the [`Embed`](/api/carbon/embed) class.
...
class TestEmbed extends Embed {
		...
		color = 16711680;
		image = "https://cdn.buape.com/carbon/wordmark.png";
		thumbnail = "https://cdn.buape.com/carbon/logo.png";
		author = {
				name: "Author Name",
