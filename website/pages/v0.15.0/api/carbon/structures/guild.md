...
| fetchChannels | `() => Promise<ReturnType<typeof channelFactory>[]>` | Yes | Fetch all channels in the guild @returns A Promise that resolves to an array of channel objects |
