...
| style | `TextInputStyle` | Yes | The style of the text input @default TextInputStyle.Short |
| minLength | `number` | No | The minimum length of the text input |
| maxLength | `number` | No | The maximum length of the text input |
| required | `boolean` | No | Whether the text input is required |
| value | `string` | No | The value of the text input |
| placeholder | `string` | No | The placeholder of the text input |
