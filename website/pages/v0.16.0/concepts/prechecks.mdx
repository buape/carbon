...
If you need shared logic across many commands (analytics, logging, tracing), use [command middlewares](/concepts/command-middlewares). Prechecks are command-local guards.
