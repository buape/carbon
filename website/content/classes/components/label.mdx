...
Labels are wrapper components used in [Modals](/api/classes/modals) to organize and describe form inputs. They are created by extending the `Label` class and contain a single form component such as a `TextInput` or any select menu.
