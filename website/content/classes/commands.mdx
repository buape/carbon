...
To create a command, you need to create a class that extends the [`Command`](/carbon/api/index/classes/Command) class. This class will handle the command and its functionality.
