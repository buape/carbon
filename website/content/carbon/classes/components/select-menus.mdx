...
Select menus are used to select an option from a list of options in a dropdown. They are created by extending the [`SelectMenu`](/carbon/api/classes/SelectMenu) class, and adding a `options` property.
