...
Link buttons are used to link to external sources. They are created by extending the [`LinkButton`](/carbon/api/classes/LinkButton) class, and adding a `url` property.
