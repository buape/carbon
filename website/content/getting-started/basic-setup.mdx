...
Next, create a handle function by passing a client factory to the [`createHandle`](https://carbon.buape.com/carbon/functions/createhandle) function. The factory should return an array of plugins, the first being the client, and the rest being any other optional plugins you may want to add.
