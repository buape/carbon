...
- [Bookmarker](https://go.daksh.cc/add-bookmarker-bot) - Free to use Discord bot that let's you "bookmark" messages by sending them to your DMs. Manage these bookmarks directly in your DMs with Bookmarker. Supports user apps, categories, notes and more! Project is open source find the code [here](https://github.com/BookmarkerBot/Bookmarker) 
