---
title: Node.js
description: Learn how to set up and deploy your Carbon bot using Node.js, including development and production environments.
icon: Hexagon
---
...
Using the `@buape/carbon/adapters/node` package, you can create a server to host your bot. This server will handle incoming interactions and route them to your bot.
